...
//            fail(msg);
    ...
    public void iLoginToJiraUsingUsernameAndAccessCredentialsPassword() throws Throwable {
        try {
            boolean flag = false;
            //String strUserName,strPassword;
            ...
            //String name = p.getProperty("iwms.username");
            //System.out.println(name);
            //String pass = p.getProperty("iwms.password1");
            //String foo = p.getProperty("foo");

            // Load browser and point it at configured IWMS web-ui.
            BrowserDriver.loadPage(appURL);

            LoginViews.enterUsername(username);
            LoginViews.enterJiraPassword(pass);
...
//            URL url = strStackName+"."+"rlcatalyst.com"; CucumberContext.getURL();
   ...
   /* @Before
    ...
    public void iSignOutOfJiraAccount(){
        try{
